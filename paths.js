...
// `stateDir` était hardcodé à l'identique dans legacy-mcp-inject.js ET
// ctxroute-reset.js — deux copies d'une même vérité qui divergent en silence
...
// réglage utilisateur (la config utilisateur, c'est ctxroute-config.json).
...
// ctxroute-config.json → framework laissé désactivé en prod, en silence.
//
