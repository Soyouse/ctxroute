...
// ⚠️ Env var RÉSERVÉE AUX TESTS (même doctrine que les env vars de paths.js —
//    jamais un réglage utilisateur) : les tests de CONCURRENCE prouvent
//    l'ATOMICITÉ du lock (aucune écriture perdue), pas sa DISPONIBILITÉ (le
//    timeout fail-open, choix séparé et voulu). Sous charge (CI saturée, suites
