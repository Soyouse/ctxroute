...
//
// ⚠️⚠️ POURQUOI CE FICHIER EXISTE : ces règles vivaient DANS `tests/deps-criticite-gate.test.js`. Or
...
function estEpingleExact(plage) {
...
function depsNonClassees(deps, moteurs, ordinaires) {
...
function entreesFantomes(deps, moteurs, ordinaires) {
...
// ⚠️ CommonJS ICI, et c'est une CONTRAINTE du repo, pas un goût : les hooks sont spawnés à CHAQUE appel
//    d'outil et le loader ESM est plus lent que `require`. Ne JAMAIS ajouter `"type":"module"`.
module.exports = { EXACT_VERSION, estEpingleExact, fautesEpinglage, depsNonClassees, entreesFantomes };
