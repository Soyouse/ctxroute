...
Les 3 env vars (`MCP_DOC_CONFIG_PATH`/`DOCS_DIR`/`STATE_DIR`) sont RÉSERVÉES aux tests et à doctor.js — jamais un réglage utilisateur (ça, c'est `mcp-doc-config.json`).
